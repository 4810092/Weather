-- Required category evidence and separate search diagnostics from the canonical 2026-09-01 UZ capture at
-- 2026-09-01T01:02:39+05:00. Goal evidence is complete. The separately
...
FROM (
  VALUES
    ('App Store UZ search', 'all', 'weather', '>192', 10, 'fixed_public_capture'),
    ('App Store UZ Weather chart', 'official', 'category', '66', 10, 'fixed_public_capture'),
    ...
    ('Google Play UZ generic-query diagnostic', '2-of-3 profiles', 'five configured queries', '0 qualifying queries', 2, 'fixed_logged_out_capture')
