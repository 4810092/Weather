...
- The coordinated `1.1.0` source identities are Android phone 8, Wear 1000008,
  ...
  source `5b98f23` has no retained signed candidate bytes. Historical QA
  does not establish signing or physical coverage for the current candidates.
  Current product/build source `5b98f23` keeps the Apple source-revision and
  ...
  [source-sync gate](growth/quality/release-artifact-source-sync-2026-08-30-5b98f23.md),
